...
| SUB003 | Multi-Model Ensemble (Template + ResNet + Transformer) | IT002 | IT004 (ResNet + Transformer) | SUB003 (inline) | N/A | [notebook](submission_SUB003.ipynb) | [metadata](submission_SUB003.md) | 0.246 |
